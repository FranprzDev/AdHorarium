        ...
        <section className="py-20 md:py-32">
          <div className="max-w-7xl mx-auto text-center">
            ...
            >
              ...
              Gestiona correlativas, optimiza horarios y encuentra información de mesas.
            </motion.p>
                ...
                >
                  <Card className="glass-card p-6 h-full flex flex-col">
                    <CardContent className="p-0 flex flex-col h-full">
                      ...
                      <p className="text-purple-200 mb-6 italic leading-relaxed flex-1">
                        {`"${testimonial.content}"`}
                      </p>
                ...
                {[
                  {
                    ...
                    description:
                      "Accedé con tu email y contraseña o con Google. Tu privacidad está protegida con los más altos estándares.",
                  ...
                  },
                  {
                    ...
                    description:
                      "Seleccioná tu carrera y año de cursado. AdHorarium se adapta automáticamente a tu plan de estudios.",
                    icon: <Target className="h-8 w-8 text-blue-400" />,
                  },
                  {
                    step: 3,
                    title: "Explorá las herramientas",
                    description:
                      "Utilizá el plan de correlativas, gestor de horarios y buscador de mesa. Cada herramienta está optimizada para tu éxito.",
