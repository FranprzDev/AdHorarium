...
import { BookOpen, LinkIcon, Menu, X, LogOut, UserIcon, Shield, BarChart3 } from "lucide-react"
...
export function AdminLayout({ children }: AdminLayoutProps) {
  ...
  const navItems = [
    ...
    { name: "Gestión de Materias", path: "/admin/dashboard/subjects", icon: <BookOpen className="h-5 w-5" /> },
    { name: "Gestión de Correlativas", path: "/admin/dashboard/correlatives", icon: <LinkIcon className="h-5 w-5" /> },
  ]
    ...
    <div className="min-h-screen gradient-bg">
      ...
      >
        <div className="flex flex-col h-full p-4">
          ...
          <Badge variant="outline" className="border-purple-500/30 text-purple-300 mb-6 justify-center">
